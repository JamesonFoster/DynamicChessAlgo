...
CAR_IMAGES = [
    'C:\\Users\\patte\\OneDrive\\Desktop\\DSA Project Group\\CarPNGs\\redcar.png', 
    'C:\\Users\\patte\\OneDrive\\Desktop\\DSA Project Group\\CarPNGs\\blackcar.png',
    'C:\\Users\\patte\\OneDrive\\Desktop\\DSA Project Group\\CarPNGs\\browncar.png',
    'C:\\Users\\patte\\OneDrive\\Desktop\\DSA Project Group\\CarPNGs\\bluecar.png'
]
...
def highlight_road(car, map_widget):
    ...
    if len(car.path) > 0:
        ...
        map_widget.set_marker(end.x, end.y, text="Destination")
#========================GET ANGLE FUNCTION============================#
